...
class CuadroType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
          ...
          ->add('insumo', 'entity',array('label'  => 'Productos :', 'class' => 'MinsalCoreBundle:CtlInsumo', 'choice_label' => 'nombreLargoInsumo',  'required' => true, 'disabled' => false, 'multiple' => true, 'attr' => array('data-placeholder' => 'Seleccione los insumos', 'style' => 'width: 90%'),))
          ;
    }
