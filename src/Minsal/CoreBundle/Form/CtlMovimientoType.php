...
class CtlMovimientoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
			...
			->add('almacenFarmacia')
			->add('loteMovimiento')
			->add('ctlTipoMovimientoid', 'entity',array('label'  => 'Movimientos :', 'class' => 'MinsalCoreBundle:CtlTipoMovimiento', 'choice_label' => 'nombreMovimiento', 'required' => true,'empty_data' => 'Selecciones un ', 'disabled' => false, 'multiple' => false, 'attr' => array('class' => 'form-control select2', 'data-placeholder' => 'Seleccione el movimiento', 'style' => 'width: 90%', 'onchange' => 'cargar(this.value);'),))
			...
			'choice_label' => 'Largo','required' => true, 'multiple' => false, 'attr' => array('class' => 'form-control select2', 'style' => 'width: 90%', "data-placeholder"=>"Select a State")))
